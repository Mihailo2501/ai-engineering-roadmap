  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        source: "Mem0",
        est: "1-2h",
        note: "Field overview of memory architectures beyond plain RAG.",
      },
    ],
  },
  {
    ...
    resources: [
      ...
      {
        id: "p4-langgraph-ts",
        title: "LangGraph Essentials: TypeScript Quickstart",
        url: "https://academy.langchain.com/courses/quickstart-langgraph-essentials-typescript",
