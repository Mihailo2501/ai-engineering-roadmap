...
export function RoadmapPage() {
  ...
  return (
    <>
      <PageHero
        eyebrow="Personal study tracker"
        title="Roadmap"
        intro="Seven phases from re-reading the fundamentals to shipping an eval-gated agent on managed infrastructure. Check resources off as you finish them. Progress saves locally."
      >
        <div className="mt-6">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <footer className="mt-16 border-t border-slate-200 pt-6 text-sm text-slate-500">
          <p>
            A personal artifact. Companion study notes live in a separate
            scratchpad project, see the{" "}
            <a
              href="#/study"
